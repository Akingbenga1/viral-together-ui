...
// Dynamic import of InteractiveMap to avoid SSR issues with Leaflet
const InteractiveMap = dynamic(() => import('@/components/InteractiveMap'), {
  ssr: false,
  loading: () => <div className="h-[400px] bg-gray-100 rounded-md flex items-center justify-center">Loading map...</div>
});
          ...
          {activeTab === 'user' && (
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                {errors.username && (
                  <p className="form-error">{String(errors.username?.message || "")}</p>
                )}
              </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-slate-800/30 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50">
                ...
                <div className="mt-4">
                  ...
                  />
                  {errors.bio && (
                    <p className="form-error">{String(errors.bio?.message || "")}</p>
                  )}
                </div>
              </div>
              ...
              <div className="bg-slate-800/30 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {errors.businessName && (
                      <p className="form-error">{String(errors.businessName?.message || "")}</p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.industry && (
                      <p className="form-error">{String(errors.industry?.message || "")}</p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    {errors.contactEmail && (
                      <p className="form-error">{String(errors.contactEmail?.message || "")}</p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    {errors.contactPhone && (
                      <p className="form-error">{String(errors.contactPhone?.message || "")}</p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.businessSize && (
                      <p className="form-error">{String(errors.businessSize?.message || "")}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="mt-4">
                  ...
                  {errors.businessDescription && (
                    <p className="form-error">{String(errors.businessDescription?.message || "")}</p>
                  )}
                </div>
              </div>
