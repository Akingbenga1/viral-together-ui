      ...
      <div className="p-6 lg:p-8">
        ...
        <div className="bg-slate-800/30 backdrop-blur-sm rounded-2xl border border-slate-700/50 overflow-hidden mb-8">
          <div className="p-4 lg:p-6">
            ...
            <InteractiveMap 
              initialLat={filteredLocations[0]?.latitude ? Number(filteredLocations[0].latitude) : 40.7128}
              initialLng={filteredLocations[0]?.longitude ? Number(filteredLocations[0].longitude) : -74.0060}
              onLocationSelect={(lat, lng, cityName, countryCode, countryName) => {
                console.log('Selected location:', { lat, lng, cityName, countryCode, countryName });
              }}
            />
          </div>
        </div>
