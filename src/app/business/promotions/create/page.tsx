...
export default function CreatePromotionPage() {
  ...
  const [errors, setErrors] = useState<Partial<Record<keyof CreatePromotionData, string>>>({});
  ...
  useEffect(() => {
    const fetchUserBusinesses = async () => {
      ...
      try {
        ...
        const userBusinesses = allBusinesses.filter((b: any) => b.owner_id === user.id);
        setBusinesses(userBusinesses as any);
  ...
  const validateForm = (): boolean => {
    const newErrors: Partial<Record<keyof CreatePromotionData, string>> = {};
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const promotionData = {
        ...
        social_media_platform_id: formData.social_media_platform_id
      };
