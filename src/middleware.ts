...
export function middleware(request: NextRequest) {
  ...
  const publicRoutes = ['/auth/login', '/auth/register', '/pricing', '/partners', '/about', '/people', '/help', '/contact', '/privacy', '/privacy-policy', '/terms-of-service', '/auth/forgot-password', '/auth/reset-password', '/subscription'];
